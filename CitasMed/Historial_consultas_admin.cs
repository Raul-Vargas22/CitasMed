...
namespace CitasMed
{
    public partial class Historial_consultas_admin : Form
    {
        public Historial_consultas_admin()
        {
            InitializeComponent();
        ...
        private void Historial_consultas_admin_Load(object sender, EventArgs e)
        {
