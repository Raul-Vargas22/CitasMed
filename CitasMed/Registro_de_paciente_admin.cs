...
namespace CitasMed
{
    public partial class Registro_de_paciente_admin : Form
    {
        ...
        public Registro_de_paciente_admin()
        {
            InitializeComponent();
        ...
        public Registro_de_paciente_admin(int idPaciente)
        {
            InitializeComponent();
        ...
        private void btnMenu_admin_Click(object sender, EventArgs e)
        {
